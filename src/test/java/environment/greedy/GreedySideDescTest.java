...
class GreedySideDescTest {
    ...
    private static final String ALGORITHM_NAME = "Greedy_FF_BL_SideDESC";
    ...
    private Greedy<PackingSolution, Rectangle> buildAlgorithm() {
        ...
        return new Greedy<>(new SideDescOrder(), new FirstFitStrategy(bottomLeft));
    }
    ...
    private void runMode(String modeName, int[][] tuples) {
        ...
        // target/csv/greedy_side_desc_fast.csv  or  ..._large.csv
        Path path = Paths.get("target", "csv", "greedy_side_desc_" + modeName + ".csv");
